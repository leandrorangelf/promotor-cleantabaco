...
assert.ok(html.includes('Visitas/dia'), 'gestao deve mostrar media de visitas por dia por promotor');
assert.ok(html.includes('Pacotes vendidos'), 'gestao deve mostrar pacotes vendidos por promotor');
assert.ok(html.includes('Fotos aprovadas'), 'gestao deve mostrar fotos aprovadas por promotor');
assert.ok(html.includes('function fotosAprovadasDoPromotor'), 'deve existir calculo de fotos aprovadas');
